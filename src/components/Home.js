...
const Home = () => {
  return (
<section className="relative overflow-hidden px-8 pt-44 pb-20 bg-white dark:bg-[#0A0F2C] transition-all duration-700">
  ...
  <span className="block bg-gradient-to-r from-[#00A884] via-[#00C6B1] to-[#00D4FF] text-transparent bg-clip-text">
    Potential
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            ...
            <Link
              to="/contact"
              className="flex items-center gap-2 bg-white text-gray-800 dark:bg-gray-900 dark:text-gray-200 px-6 py-3 rounded-xl font-medium border border-gray-200 dark:border-gray-700 shadow-md hover:shadow-lg hover:scale-[1.03] transition-all"
            >
              Get in Touch →
            </Link>
          </div>
      ...
      <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
        ...
        <div className="relative flex justify-center items-center">
          <div className="relative w-full max-w-lg">
            ...
            <div className="absolute bottom-12 right-0 bg-gradient-to-r from-pink-500 to-fuchsia-500 text-white rounded-full p-4 shadow-lg z-20">
              <Brain size={26} />
            </div>
...
<div className="max-w-7xl mx-auto mt-32 text-center">
  ...
  <p className="text-gray-600 dark:text-gray-400 text-lg mb-16">
    Leveraging the latest advances in artificial intelligence and machine learning
  </p>
...
<div className="max-w-7xl mx-auto mt-32 text-center">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
    {[
      ...
      >
        {/* Gradient top border */}
        <div className={`h-1.5 w-full bg-gradient-to-r ${t.gradient}`}></div>
...
<div className="max-w-5xl mx-auto mt-32 mb-24">
  <div className="bg-gradient-to-r from-emerald-400 to-cyan-500 rounded-3xl shadow-lg text-center text-white py-20 px-8 relative overflow-hidden">
    ...
    {/* Title */}
    <h2 className="text-4xl font-semibold mb-4 mt-8">Join Our Internship Program</h2>
    <p className="text-white/90 text-lg max-w-2xl mx-auto leading-relaxed">
      Gain hands-on experience and work on real-world projects with our expert team.
      Apply now to kickstart your career in AI and Data Science.
    </p>
...
<div className="max-w-7xl mx-auto mt-32 mb-24 text-center">
  {/* Tag */}
  <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-emerald-50 text-emerald-700 font-medium shadow-md border border-emerald-100 mb-4">
    <Sparkles className="w-4 h-4 text-emerald-600" />
    Get In Touch
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
    ...
    <div className="bg-white dark:bg-[#0E1835]/90 rounded-2xl shadow-md p-8 text-left border-t-4 border-emerald-400 transition-all duration-300">
      ...
      <form className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full bg-emerald-500 text-white font-medium px-5 py-3 rounded-lg hover:bg-emerald-600 transition-all flex justify-center items-center gap-2"
        >
    ...
    <div className="bg-white dark:bg-[#0E1835]/90 rounded-2xl shadow-md p-8 text-left border-t-4 border-emerald-400 transition-all duration-300 flex flex-col justify-between">
      ...
      <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl px-6 py-4 flex items-center justify-between text-emerald-700 dark:text-emerald-400 font-medium shadow-inner">
  ...
  <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 text-gray-700 dark:text-gray-300">
    ...
    <div>
      <div className="flex items-center gap-3 mb-3">
        ...
        <div>
          <h2 className="text-emerald-600 font-semibold text-lg tracking-tight">SmaranAI</h2>
      ...
      <p className="text-gray-600 dark:text-gray-400 leading-relaxed max-w-xs">
        Empowering students to achieve academic excellence through expert guidance and innovative learning solutions.
      </p>
    </div>
    ...
    <div>
      ...
      <ul className="space-y-2 text-sm">
        ...
        <li><a href="/research" className="hover:text-emerald-500 transition">Why Us</a></li>
        <li><a href="/academic-projects" className="hover:text-emerald-500 transition">Testimonials</a></li>
